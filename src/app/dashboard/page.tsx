...
export default function DashboardPage() {
  ...
  return (
    <div className="flex justify-center flex-col min-h-screen w-full bg-gradient-to-br from-slate-50 to-gray-100">
        ...
        <main className="max-w-7xl mx-auto py-4 flex justify-center w-full">
          ...
          <div className="flex justify-center gap-2 ">
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      <h2 className="text-xs font-semibold text-gray-800 flex items-center gap-2">
                        <span className="text-2xl">⭐</span> Lista de
                        importancia
                      </h2>
                    </div>
            ...
            <div className="flex flex-col gap-4 w-[300] ">
              ...
              {/* Accesos rápidos a las secciones de MTH */}
              <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-2">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-1">
                  {navSections.map((section) => (
                    <a
                      key={section.name}
                      href={section.href}
                      className={`group bg-gradient-to-br ${section.gradient} rounded-xl p-2 text-center hover:shadow-md transition-all border ${section.border} ${section.hoverBorder}`}
                    >
