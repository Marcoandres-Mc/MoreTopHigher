        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center gap-3">
              <button className="text-gray-600 hover:text-gray-900 px-3 py-1 rounded-lg text-sm font-medium">
                Perfil
              </button>
              <button className="bg-blue-600 text-white px-4 py-2 rounded-xl text-sm font-medium hover:bg-blue-700 transition shadow-sm">
                Salir
              </button>
            </div>
          </div>
            ...
            <div className="md:col-span-2 bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
              ...
              <div className="divide-y divide-gray-100">
                {importancia.map((item) => (
                  <div
                    key={item.id}
                    className="px-2 py-2 flex items-center justify-between hover:bg-gray-50 transition"
                  >
                    <div className="flex items-center gap-3">
                      <div
                        className={`w-2 h-2 rounded-full ${item.prioridad === "alta" ? "bg-red-500" : "bg-yellow-500"}`}
                      />
                      <div>
                    ...
                    <button className="text-gray-400 hover:text-blue-600 text-sm transition">
                      Ver →
                    </button>
                  </div>
                ))}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-gradient-to-br from-emerald-50 to-emerald-100/40 rounded-2xl shadow-md border border-emerald-200 p-6 transition-all hover:shadow-lg flex flex-col items-center">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-xs bg-emerald-200 text-emerald-800 px-2 py-1 rounded-full font-semibold ml-2">
                    Racha 🔥
                  </span>
                </div>
              ...
              <div className="bg-gradient-to-br from-blue-50 to-indigo-100/40 rounded-2xl shadow-md border border-blue-200 p-6 transition-all hover:shadow-lg flex flex-col items-center">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-xs bg-blue-200 text-blue-800 px-2 py-1 rounded-full font-semibold ml-2">
                    Promedio
                  </span>
                </div>
                ...
                {[
                  {
                    ...
                    url: "https://estudiante.upc.edu.pe/",
                  },
                  {
                    id: 2,
                    nombre: "UPC",
                    url: "https://aulavirtual.upc.edu.pe/ultra/profile",
                  },
                  {
                    id: 3,
                    nombre: "GitHub",
                    url: "https://github.com/Marcoandres-Mc",
                  },
                  {
                    id: 4,
                    nombre: "NoteBookLm",
            ...
            <div className="bg-gradient-to-br from-indigo-500 to-purple-600 rounded-2xl shadow-lg p-4 text-white">
              ...
              <div className="flex justify-between">
                {[1, 1, 0, 1, 1, 0, 1].map((activo, i) => (
                  <div
                    key={i}
                    className={`w-7 h-7 rounded-full flex items-center justify-center text-xs ${activo ? "bg-white/30 text-white" : "bg-white/10 text-white/50"}`}
                  >
                    {activo ? "✓" : "-"}
                  </div>
                ))}
              ...
              <div className="divide-y divide-gray-100">
                {habitsHoy.map((habito) => (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <div
                        className={`w-5 h-5 rounded border-2 flex items-center justify-center cursor-pointer transition ${habito.completado ? "bg-green-500 border-green-500" : "border-gray-300 hover:border-green-400"}`}
                      >
                        {habito.completado && (
                      ...
                      <span
                        className={`text-gray-700 text-xs ${habito.completado ? "line-through text-gray-400" : ""}`}
                      >
                        {habito.nombre}
                      </span>
                    ...
                    <button className="text-blue-600 text-sm text-xs font-medium">
                      Detalle
                    </button>
                  </div>
                ))}
