...
export default function EnglishPage() {
  ...
  const [links, setLinks] = useState([
    ...
    { id: 3, nombre: "Grammarly", url: "https://www.grammarly.com", categoria: "herramienta" },
    { id: 4, nombre: "YouTube - English Addict", url: "https://www.youtube.com/@EnglishAddict", categoria: "video" },
    { id: 5, nombre: "Cambridge English", url: "https://www.cambridgeenglish.org", categoria: "examen" },
  ]);
  ...
  const agregarLink = () => {
    ...
    if (!url) return;
    const nuevaCategoria = prompt("Categoría (app, curso, herramienta, video, examen):", "curso");
    const nuevoId = Math.max(...links.map(l => l.id), 0) + 1;
    setLinks([...links, { id: nuevoId, nombre, url, categoria: nuevaCategoria || "curso" }]);
  };
  ...
  return (
    <div className="space-y-6 bg-gradient-to-br from-slate-50 to-gray-100 p-10">
      <h1 className="text-3xl font-bold text-gray-800 flex items-center gap-2">
        <span className="text-4xl">🇬🇧</span> Mi progreso en inglés
      </h1>
          ...
          <div className="bg-gradient-to-br from-emerald-50 to-teal-100/40 rounded-2xl shadow-md border border-emerald-200 p-6 flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="flex-1 space-y-3">
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="font-bold text-orange-600">{racha} días seguidos</span>
              </div>
              <div className="flex items-center justify-between">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
              ...
              <div className="w-full bg-gray-200 rounded-full h-3">
                <div className="bg-blue-600 h-3 rounded-full" style={{ width: `${progresoMeta}%` }} />
              </div>
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
              ...
              <div className="w-full bg-gray-200 rounded-full h-3">
                <div className="bg-emerald-600 h-3 rounded-full" style={{ width: `${progresoPalabras}%` }} />
              </div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-2xl shadow-md border border-gray-100 p-4">
            ...
            <div className="space-y-2 max-h-[500px] overflow-y-auto pr-1">
              {links.map((link) => (
                ...
                >
                  <button
                    onClick={(e) => { e.stopPropagation(); eliminarLink(link.id); }}
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-5">
            ...
            <div className="space-y-2 text-sm">
              <p>✅ 5 de 7 días estudiados esta semana</p>
              <p>🎯 A 3 semanas de alcanzar tu meta B2</p>
              <p>🏆 Top 15% de estudiantes activos</p>
            </div>
          </div>
        </div>
      </div>
